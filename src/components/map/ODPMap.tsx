...
export const ODPMap: React.FC<ODPMapProps> = ({ 
  ...
  useEffect(() => {
    if (initialODPId != null) {
      const idToFind = Number(initialODPId);
      const found = odps.find(o => o.id === idToFind);
      if (found) {
      ...
      >
        <>
          <TileLayer
            ...
            key={mapLayer}
            errorTileUrl="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQYV2P4z8DwHwAFZQJtQwOukAAAAABJRU5ErkJggg=="
            updateWhenIdle={true}
